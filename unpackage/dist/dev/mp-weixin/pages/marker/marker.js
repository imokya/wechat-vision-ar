  ...
  setup(__props) {
    ...
    common_vendor.onMounted(() => {
      common_vendor.index.createSelectorQuery().select("#webgl").node().exec((res) => {
        ...
        new objects_MarkerExperience.MarkerExperience(canvas);
      });
    });
    return (_ctx, _cache) => {
      return {
...
var MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "C:/Users/Administrator/Desktop/wechat-vision-ar/wechat-vision-ar/pages/marker/marker.vue"]]);
